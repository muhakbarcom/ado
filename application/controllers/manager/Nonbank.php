...
class Nonbank extends CI_Controller
{
	public function index()
	{
		$data['nonbank'] = $this->db->query("SELECT * FROM ado WHERE jenis_ado='Non-Bank' order by id_ado DESC")->result();
		$this->load->view('template/header');
		$this->load->view('manager/sidebar');
		$this->load->view('manager/v_nonbank', $data);
	...
	public function tambah_data()
	{
		$this->load->view('template/header');
		$this->load->view('manager/sidebar');
		$this->load->view('manager/tambah_nonbank');
		$this->load->view('template/footer');
	}
	public function tambah_nonbank_aksi()
	{
	...
	public function detail($id)
	{
		...
		$this->load->view('template/header');
		$this->load->view('manager/sidebar');
		$this->load->view('manager/detail_nonbank', $data);
		$this->load->view('template/footer');
	}
	public function update_data($id)
	{
		...
		$this->load->view('template/header');
		$this->load->view('manager/sidebar');
		$this->load->view('manager/update_nonbank', $data);
		$this->load->view('template/footer');
	}

	public function update_nonbank_aksi()
	{
	...
	public function delete_nonbank($id)
	{
		$where = array('id_ado' => $id);
