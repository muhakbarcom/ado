...
class sekolahuniversitas extends CI_Controller
{
	...
	{
		$data['sekolahuniversitas'] = $this->db->query("SELECT * FROM ado WHERE jenis_ado='Sekolah/Universitas'")->result();
		$this->load->view('template/header');
		$this->load->view('manager/sidebar');
		$this->load->view('manager/v_sekolahuniversitas', $data);
	...
	public function tambah_data()
	{
		$this->load->view('template/header');
		$this->load->view('manager/sidebar');
		$this->load->view('manager/tambah_sekolahuniversitas');
		$this->load->view('template/footer');
	}
	public function tambah_sekolahuniversitas_aksi()
	{
		...
		if ($this->form_validation->run() == FALSE) {
			...
			if ($this->upload->do_upload('foto_ado')) {
				...
				redirect('manager/sekolahuniversitas');
			}
		}
	}
	public function detail($id)
	{
		...
		$this->load->view('template/header');
		$this->load->view('manager/sidebar');
		$this->load->view('manager/detail_sekolahuniversitas', $data);
		$this->load->view('template/footer');
	}
	public function update_data($id)
	{
		...
		$this->load->view('template/header');
		$this->load->view('manager/sidebar');
		$this->load->view('manager/update_sekolahuniversitas', $data);
		$this->load->view('template/footer');
	}
