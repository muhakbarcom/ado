...
class daop extends CI_Controller
{
	...
	public function index()
	{
		...
		$this->load->view('manager/v_ado', $data);
		$this->load->view('template/footer');
	}
	public function print_data_belum()
	{
		$data['ado'] = $this->db->query("SELECT * FROM ado where status='Belum Prospek'")->result();
		$this->load->view('admin/print_ado', $data);
	}
	public function print_data_sudah()
	{
		$data['ado'] = $this->db->query("SELECT * FROM ado where status='Sudah Prospek'")->result();
		$this->load->view('admin/print_ado', $data);
	}
	public function tambah_data()
	{
		...
		$this->load->view('template/header');
		$this->load->view('manager/sidebar');
		$this->load->view('manager/tambah_ado');
		$this->load->view('template/footer');
	}
	...
	public function update_data($id)
	{
		...
		$this->load->view('template/header');
		$this->load->view('manager/sidebar');
		$this->load->view('manager/update_ado', $data);
		$this->load->view('template/footer');
	}
	...
	public function print_data()
	{
		...
		$this->load->view('manager/print_ado', $data);
	}
	public function detail($id)
	{
		...
		$this->load->view('template/header');
		$this->load->view('manager/sidebar');
		$this->load->view('manager/detail_ado', $data);
		$this->load->view('template/footer');
	}
	public function print_id($id)
	{
		...
		$this->load->view('manager/cetak_ado', $data);
	}
}
