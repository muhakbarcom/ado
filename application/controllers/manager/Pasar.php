...
class Pasar extends CI_Controller
{
	public function index()
	{
		...
		$this->load->view('manager/v_pasar', $data);
	...
	public function tambah_data()
	{
		$this->load->view('template/header');
		$this->load->view('manager/sidebar');
		$this->load->view('manager/tambah_pasar');
		$this->load->view('template/footer');
	}
	public function tambah_pasar_aksi()
	{
	...
	public function detail($id)
	{
		...
		$this->load->view('template/header');
		$this->load->view('manager/sidebar');
		$this->load->view('manager/detail_pasar', $data);
		$this->load->view('template/footer');
	}
	public function update_data($id)
	{
		...
		$this->load->view('template/header');
		$this->load->view('manager/sidebar');
		$this->load->view('manager/update_pasar', $data);
		$this->load->view('template/footer');
	}

	public function update_pasar_aksi()
	{
