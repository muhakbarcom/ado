...
class Perusahaan extends CI_Controller
{
	...
	{
		$data['perusahaan'] = $this->db->query("SELECT * FROM ado WHERE jenis_ado='Perusahaan' order by id_ado DESC")->result();
		$this->load->view('template/header');
		$this->load->view('manager/sidebar');
		$this->load->view('manager/v_perusahaan', $data);
	...
	public function tambah_data()
	{
		$this->load->view('template/header');
		$this->load->view('manager/sidebar');
		$this->load->view('manager/tambah_perusahaan');
		$this->load->view('template/footer');
	}
	...
	public function detail($id)
	{
		...
		$this->load->view('template/header');
		$this->load->view('manager/sidebar');
		$this->load->view('manager/detail_perusahaan', $data);
		$this->load->view('template/footer');
	}
	public function update_data($id)
	{
		...
		$this->load->view('template/header');
		$this->load->view('manager/sidebar');
		$this->load->view('manager/update_perusahaan', $data);
		$this->load->view('template/footer');
	}

	public function update_perusahaan_aksi()
	{
