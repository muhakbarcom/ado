...
class kecamatan extends CI_Controller
{
	public function index()
	{
		...
		$this->load->view('manager/v_kecamatan', $data);
	...
	public function tambah_data()
	{
		...
		$this->load->view('template/header');
		$this->load->view('manager/sidebar');
		$this->load->view('manager/tambah_kcmt', $data); // JENIS
		$this->load->view('template/footer');
	}
	...
	public function detail($id)
	{
		...
		$this->load->view('template/header');
		$this->load->view('manager/sidebar');
		$this->load->view('manager/detail_kecamatan', $data);
		$this->load->view('template/footer');
	}
	public function update_data($id)
	{
		...
		$this->load->view('template/header');
		$this->load->view('manager/sidebar');
		$this->load->view('manager/update_kecamatan', $data);
		$this->load->view('template/footer');
	}

	public function update_kcmt_aksi()
	{
	...
	public function delete_kcmt($id)
	{
		$where = array('id_ado' => $id);
