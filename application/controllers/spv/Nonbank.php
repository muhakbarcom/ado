...
class Nonbank extends CI_Controller
{
	public function index()
	{
		...
		$this->load->view('spv/v_nonbank', $data);
	...
	public function tambah_data()
	{
		$this->load->view('template/header');
		$this->load->view('spv/sidebar');
		$this->load->view('spv/tambah_nonbank');
		$this->load->view('template/footer');
	}
	...
	public function detail($id)
	{
		...
		$this->load->view('template/header');
		$this->load->view('spv/sidebar');
		$this->load->view('spv/detail_nonbank', $data);
		$this->load->view('template/footer');
	}
	public function update_data($id)
	{
		...
		$this->load->view('template/header');
		$this->load->view('spv/sidebar');
		$this->load->view('spv/update_nonbank', $data);
		$this->load->view('template/footer');
	}
