...
class sekolahuniversitas extends CI_Controller
{
	public function index()
	{
		...
		$this->load->view('spv/v_sekolahuniversitas', $data);
	...
	public function tambah_data()
	{
		$this->load->view('template/header');
		$this->load->view('spv/sidebar');
		$this->load->view('spv/tambah_sekolahuniversitas');
		$this->load->view('template/footer');
	}
	public function tambah_sekolahuniversitas_aksi()
	{
		...
		if ($this->form_validation->run() == FALSE) {
			...
			if ($this->upload->do_upload('foto_ado')) {
				...
				redirect('spv/sekolahuniversitas');
			}
		}
	}
	public function detail($id)
	{
		...
		$this->load->view('template/header');
		$this->load->view('spv/sidebar');
		$this->load->view('spv/detail_sekolahuniversitas', $data);
		$this->load->view('template/footer');
	}
	public function update_data($id)
	{
		...
		$this->load->view('template/header');
		$this->load->view('spv/sidebar');
		$this->load->view('spv/update_sekolahuniversitas', $data);
		$this->load->view('template/footer');
	}
