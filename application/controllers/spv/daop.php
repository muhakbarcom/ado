...
class daop extends CI_Controller
{
	...
	public function update_data($id)
	{
		...
		$this->load->view('template/header');
		$this->load->view('spv/sidebar');
		$this->load->view('spv/update_ado', $data);
		$this->load->view('template/footer');
	}
	...
	public function print_data()
	{
		...
		$this->load->view('spv/print_ado', $data);
	}
	public function detail($id)
	{
		...
		$this->load->view('template/header');
		$this->load->view('spv/sidebar');
		$this->load->view('spv/detail_ado', $data);
		$this->load->view('template/footer');
	}
	public function print_id($id)
	{
		...
		$this->load->view('spv/cetak_ado', $data);
	}
}
