                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <a href="<?= base_url('manager/daop/print_data_sudah') ?>" class="btn btn-info mb-3 ml-3"> Print Data</a>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <a href="<?= base_url('manager/daop/print_data_belum') ?>" class="btn btn-info mb-3 ml-3"> Print Data</a>
                        </div>
                    </div>
                </div>