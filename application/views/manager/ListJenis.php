        ...
        <div class="container-fluid pt-4 px-4">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <form method="post" action="<?= base_url('manager/analisis/analisis_aksi') ?>">
                            ...
                            <table class="table table-bordered table-striped">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?= base_url("manager/analisis/edit/") . $jns->id_ado  ?>" class="btn btn-primary btn-sm">Analisis</a> |
                                            <?php if ($jns->status == 'Sudah Prospek') : ?>
                                                <a href="<?= base_url("manager/analisis/un_validasi/$jns->id_ado/$jns->jenis_ado")  ?>" class="btn btn-success btn-sm"><i class="fa fa-check"></i></a>
                                            <?php else : ?>
                                                <a href="<?= base_url("manager/analisis/validasi/$jns->id_ado/$jns->jenis_ado")  ?>" class="btn btn-secondary btn-sm"><i class="fa fa-check"></i></a>
                                            <?php endif ?>
