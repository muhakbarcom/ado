                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php if ($jns->status == 'Sudah Prospek') : ?>
                                                <a href="<?= base_url("manager/analisis/un_validasi/$jns->id_ado")  ?>" class="btn btn-success btn-sm"><i class="fa fa-check"></i></a>
                                            <?php else : ?>
                                                <a href="<?= base_url("manager/analisis/validasi/$jns->id_ado")  ?>" class="btn btn-secondary btn-sm"><i class="fa fa-check"></i></a>
                                            <?php endif ?>
