                <div class="container-fluid">
                    ...
                    <a href="<?= base_url('spv/asuransi/tambah_data') ?>" class="btn btn-primary mb-3"> Tambah Data</a>
                            ...
                            <table class="table table-responsive  table-striped table-hover table-bordered">
                                ...
                                foreach ($asuransi as $asuransi) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?= base_url('spv/asuransi/update_data/' . $asuransi->id_ado) ?>" class="btn btn-sm btn-primary mr-2"><i class="fas fa-edit"></i></a>
                                            <a href="<?= base_url('spv/asuransi/delete_asuransi/' . $asuransi->id_ado) ?>" class="btn btn-sm btn-danger"><i class="fas fa-trash"></i></a>
                                        </td>
                                    </tr>
