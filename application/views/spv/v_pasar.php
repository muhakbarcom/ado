                <div class="container-fluid">
                    ...
                    <a href="<?= base_url('spv/pasar/tambah_data') ?>" class="btn btn-primary mb-3"> Tambah Data</a>
                            ...
                            <table class="table table-responsive  table-striped table-hover table-bordered">
                                ...
                                foreach ($pasar as $pasar) : ?>
                                    <tr>
                                        ...
                                        <td><?= $pasar->status ?></td>
                                        <td>
                                            <a href="<?= base_url('spv/pasar/update_data/' . $pasar->id_ado) ?>" class="btn btn-sm btn-primary mr-2"><i class="fas fa-edit"></i></a>
                                            <a href="<?= base_url('spv/pasar/delete_pasar/' . $pasar->id_ado) ?>" class="btn btn-sm btn-danger"><i class="fas fa-trash"></i></a>
                                        </td>
                                    </tr>
